...
- **High-Throughput Ingestion**: Asynchronous Node.js (Express.js) backend handling **10,000+ transaction events/sec** with **<50ms consumer lag** via Apache Kafka and KafkaJS.
...
- **Production Persistence**: PostgreSQL (`pg` pool) storing historical anomaly scores and classifications for underwriting analytics.
...
| Domain | Technologies |
| :--- | :--- |
| **Backend API & Data Consumer** | Node.js 20.x, Express.js, KafkaJS, PostgreSQL (`pg`), Jest |
...
- **Node.js Express Backend**: `http://localhost:8080/webhook/health`
