...
This document details all HTTP REST API endpoints exposed by the **Node.js Express Backend** and **Python FastAPI ML Inference Service**.

---

## 1. Node.js Express Webhook API (`port 8080`)
...
## 2. Node.js Express Anomaly Query API (`port 8080`)
