...
```
                      ...
                      =======================================
                                         |
                                         | Consume AnomalyResult (KafkaJS)
                                         v
                       +-----------------------------------+
                       |      Node.js Express Backend      |
                       +-----------------------------------+
                                         |
                                         v Write AnomalyEntity (pg)
                       +-----------------------------------+
...
### 1. Ingestion Layer (Node.js Express Backend)
...
- **Tech Stack**: Node.js 20.x, Express.js, KafkaJS, custom validation middleware.
...
### 4. Anomaly Alerting & Persistence Layer (PostgreSQL & Node.js Repository)
- **Responsibility**: Consumes `AnomalyResult` messages from Kafka topic `anomalies` via KafkaJS consumer in Node.js, saving structured anomaly records to PostgreSQL table `anomalies`.
